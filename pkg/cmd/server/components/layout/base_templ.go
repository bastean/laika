...
func Base(title string, content templ.Component) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<!doctype html><html lang=\"en\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><meta name=\"description\" content=\"laika\"><meta name=\"keywords\" content=\"laika\"><meta name=\"theme-color\" content=\"#1C2226\"><meta name=\"apple-mobile-web-app-capable\" content=\"yes\"><meta name=\"apple-mobile-web-app-status-bar-style\" content=\"black-translucent\"><!-- Remove \"meta robots\" and \"robots.txt\" rules for SEO --><meta name=\"robots\" content=\"noindex, nofollow, noarchive, nositelinkssearchbox, nosnippet, notranslate, noimageindex\"><!-- Dependencies/Start --><!-- HTMX --><script src=\"https://unpkg.com/htmx.org@1.9.10\" integrity=\"sha384-D1Kt99CQMDuVetoL1lrYwg5t+9QdHe7NLX/SoJYkXDFfX37iInKRy5xLSi8nO7UC\" crossorigin=\"anonymous\"></script><!-- Tailwind/Extensions --><link href=\"https://cdn.jsdelivr.net/npm/daisyui@4.4.24/dist/full.min.css\" rel=\"stylesheet\" type=\"text/css\"><!-- Tailwind --><script src=\"https://cdn.tailwindcss.com\"></script><!-- Dependencies/End --><link rel=\"manifest\" href=\"/public/static/manifest.json\"><link rel=\"apple-touch-icon\" href=\"/public/static/assets/apple-touch-icon.png\"><link rel=\"icon\" href=\"/public/static/assets/favicon.png\"><title>")
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/cmd/server/components/layout/base.templ`, Line: 51, Col: 17}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/cmd/server/components/layout/base.templ`, Line: 63, Col: 48}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/cmd/server/components/layout/base.templ`, Line: 65, Col: 48}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/cmd/server/components/layout/base.templ`, Line: 68, Col: 15}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/cmd/server/components/layout/base.templ`, Line: 73, Col: 15}
		}
		...
		switch title {
		case "home":
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<script>document.write('h'+'o'+'m'+'e'+'+'+'0'+'5'+'@'+'e'+'x'+'a'+'m'+'p'+'l'+'e'+'.'+'c'+'o'+'m');</script>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		case "dashboard":
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<script>document.write('d'+'a'+'s'+'h'+'b'+'o'+'a'+'r'+'d'+'+'+'0'+'5'+'@'+'e'+'x'+'a'+'m'+'p'+'l'+'e'+'.'+'c'+'o'+'m');</script>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		case "admin":
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<script>document.write('a'+'d'+'m'+'i'+'n'+'+'+'0'+'5'+'@'+'e'+'x'+'a'+'m'+'p'+'l'+'e'+'.'+'c'+'o'+'m');</script>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/cmd/server/components/layout/base.templ`, Line: 88, Col: 15}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/cmd/server/components/layout/base.templ`, Line: 91, Col: 15}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/cmd/server/components/layout/base.templ`, Line: 94, Col: 15}
		}
